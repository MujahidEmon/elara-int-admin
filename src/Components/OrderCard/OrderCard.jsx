    ...
    return (
        <div className="flex border-[#FCAB35] border  gap-4 bg-base text-base px-4 py-6 rounded-md shadow-2xl">
            <div className="flex gap-4">
                <div className="w-28 h-14    max-sm:w-24 max-sm:h-24 shrink-0">
                    <img
                        src={product.image}
              ...
              <span className="inline-block w-5 h-5 rounded-md bg-[#ac7f48]"></span>
                    ...
                    <div className="mt-auto flex items-center gap-3">
                        {/* <button 
                            ...
                            type="button"
                            className="flex  cursor-pointer bg-blue-950 items-center justify-center w-5 h-5 bg-base outline-none rounded-full"
                        >
                            <svg
                        ...
                        <span className="font-semibold text-sm leading-[18px]">Qty: {product.quantity}</span>
                        {/* <button
